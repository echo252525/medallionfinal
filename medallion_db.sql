...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2025 at 05:51 PM
...
(6828, 'Jericho Montuya', '321', 95500, 'jerichoxdxd25@gmail.com', '$2y$10$Kilnq7RVZqZMzMGuz33Gw.RtsnX3RJlIHWaEOC381C.WJMvJ2cPnq', '2025-05-09');
...
--
ALTER TABLE `users`
  MODIFY `userid` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6829;
COMMIT;
